package com.yele.jetpackbestpractice.domain.usecase;



import com.yele.architecture.domin.usecase.UseCase;
import com.yele.jetpackbestpractice.data.config.Configs;
...
public class DownloadUseCase extends UseCase<DownloadUseCase.RequestValues, DownloadUseCase.ResponseValue> {
    ...
    @Override
    protected void executeUseCase(DownloadUseCase.RequestValues requestValues) {
        try {
